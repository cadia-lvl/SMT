...
CRYLLIC = re.compile(r'.*[\u0400-\u04FF\u0500-\u052F\u2DE0-\u2DFF\uA640-\uA69F]+.*', re.IGNORECASE)
GREEK = re.compile(r'.*[\u0370-\u03bb\u03bd-\u03FF\u1F00-\u1FFF]+.*', re.IGNORECASE)
UNKNOWN_CHARS = re.compile(r'.*[žčšè¿ğūįł]+.*', re.IGNORECASE)
NOT_WORDS = re.compile(r'.*[\W\d_].*', re.IGNORECASE)
